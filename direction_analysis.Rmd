...
populate Connectivity.comparisons.yn as is

```{r}
ydata$Connectivity.comparisons.yn <- substr(ydata$Connectivity.comparisons, 0, 1)
```



```{r}
ydata$Connectivity.comparisons.yn <- ydata$Connectivity.comparisons
ydata$Connectivity.comparisons.yn <- as.character(ydata$Connectivity.comparisons)
head(ydata)
```
ok now fix to be either y or n
