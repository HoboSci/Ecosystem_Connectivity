...
colnames(ydata)[colnames(ydata) == "From.original.search..Y.or.N" ] <- "original_search"    
colnames(ydata)[colnames(ydata) == "Focus.on.subsidy..community..subsidy...community..or.subsidy...ecosystem" ] <- "focus" 
